<?php
/**
 * Override from mod/messages/start.php:messages_send
 * Allows to control saving of the body for each user, and later
 * to avoid double encryption when setting messages as encrypted.
 */
