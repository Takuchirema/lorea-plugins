<?php
/**
 * Assemblies -- Translation strings for Spanish
 *
 * @package        Lorea
...
$language = array (
  ...
  'assemblies:decision:group' => 'Actas del grupo',
  ...
  'assemblies:assembly:saved' => 'Assamblea guardada correctamente',
  'assemblies:assembly:location' => 'Localización',
  'assemblies:assembly:category' => 'Secciones (separadas por comas)',
  ...
  'decision:edit' => 'Editar un punto',
  'assemblies:decision:title' => 'Título',
  'assemblies:decision:description' => 'Objetivo',
  'assemblies:decision:date' => 'Fecha',
  'assemblies:decision:access_id' => 'Acceso',
  'assemblies:decision:status' => 'Estado',
  'assemblies:decision:tags' => 'Tags',
  'assemblies:decision:proposal' => 'Propuesta',
  'assemblies:decision:mode' => 'Clase',
  'assemblies:decision:owner' => 'Propuesto por %s',
  'assemblies:decision:children' => 'Propuestas para esta decisión',
  'assemblies:decision:child' => 'Propuesta',
  'assemblies:decision:none' => 'No hay decisiones',
  'assemblies:decision:category' => 'Sección',
  'assemblies:decision:section:all' => 'Todas',
  ...
  'assemblies:message:deleted_decision' => 'Punto del orden del día borrado.',
  'assemblies:error:cannot_delete_decision' => 'No se ha podido borrar el punto del orden del día',
  'assemblies:error:decision_not_found' => 'No se ha encontrado el punto de orden del día.',
  ...
  'assemblies:notification' => '%s ha realizado un llamamiento de asamblea.
...
%s',
  'assemblies:decision:link' => 'Enlazar a la próxima asamblea',
  'assemblies:decision:linked' => 'Se ha enlazado la propuesta a la próxima asamblea',
  'assemblies:decision:cantlink' => 'No se ha podido enlazar la propuesta',
  'assemblies:decision:nonext' => 'No hay asambleas pendientes',
